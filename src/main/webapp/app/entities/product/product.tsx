    ...
    return (
      <div>
        <h2 id="product-heading">
          <Translate contentKey="jhipsterReactApp.product.home.title">Products</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterReactApp.product.home.createLabel">Create a new Product</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {productList && productList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterReactApp.product.home.notFound">No Products found</Translate>
            </div>
          )}
        </div>
      </div>
